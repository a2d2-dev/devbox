...
export const APPS = [
  ...
  { id: 'terminal',  kind: 'system', name: '终端',       icon: 'terminal',  color: '#0f172a', bg: 'linear-gradient(160deg,#475569,#0f172a)' },
  { id: 'files',     kind: 'system', name: '文件',       icon: 'folder',    color: '#0891b2', bg: 'linear-gradient(160deg,#22d3ee,#0891b2)' },
  { id: 'ports',     kind: 'system', name: '端口与公网', icon: 'port',      color: T.indigo, bg: 'linear-gradient(160deg,#818cf8,#4338ca)' },
  ...
  { id: 'supervisor',kind: 'system', name: '服务监控',   icon: 'gear',      color: '#0d9488', bg: 'linear-gradient(160deg,#14b8a6,#0d9488)' },
  ...
  { id: 'supervisor-dashboard', kind: 'app', name: 'Supervisor',
    icon: 'gear', color: '#0d9488', bg: 'linear-gradient(160deg,#14b8a6,#0d9488)',
    state: 'running', version: 'v1.0', preset: 'supervisor-dashboard',
    category: '运维工具', gpu: 'CPU', gpuPct: 0, qps: null, p99: null,
    desc: '进程监控面板 · supervisord XML-RPC',
    deployedAt: '2026-05-20 08:00',
    iframeUrl: 'http://localhost:3802',
  },
];
