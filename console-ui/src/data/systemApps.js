...
//
// 这些是 agent 本地内置能力（仪表盘 / 文件 / 进程 / 磁盘 / 网络 / 告警 /
...
//
// 2026-09-08 容器域 IA 重组 T2：新增「云端应用」入口（src/pages/CloudApps.jsx），
// 承载 runtime=kubernetes 的云端下发应用（原 ComposeManager Kubernetes 筛选独立成页）。
...
export const SYSTEM_APPS = [
  ...
  { id: 'cloud-apps',          kind: 'system', name: '云端应用', icon: 'cloud',     color: '#0369a1', bg: 'linear-gradient(160deg,#38bdf8,#0369a1)' },
  ...
  { id: 'network-security',    kind: 'system', name: '网络',     icon: 'shield',    color: '#b45309', bg: 'linear-gradient(160deg,#f59e0b,#b45309)' },
  ...
  { id: 'browser',             kind: 'system', name: '浏览器',   icon: 'globe',     color: T.blue,    bg: 'linear-gradient(160deg,#3388ff,#005eeb)' },
]
