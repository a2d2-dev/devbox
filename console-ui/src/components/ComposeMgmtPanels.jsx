...
function Notice({ tone = 'blue', children }) { const colors = tone === 'red' ? ['#fef2f2','#fecaca','#b91c1c'] : tone === 'amber' ? ['#fffbeb','#fde68a','#92400e'] : ['#eff6ff','#bfdbfe','#1e40af']; return <div style={{ marginBottom: 10, padding: 10, borderRadius: 8, background: colors[0], border: `1px solid ${colors[1]}`, color: colors[2], lineHeight: 1.55 }}>{children}</div>; }
